...
Genus_soil <- ggplot(data = filter(Mines.df, Seq == "Soil"), aes(Site, Abundance, fill=factor (, levels = c ("g_unidentified", "g_Umbelopsis", "g_Tricholoma", "g_Scleroderma", "g_Russula", "g_Rhizopogon", "g_Pisolithus", "g_Oidiodendron", "g_Mortierella", "g_Meliniomycetes", "g_Leptosphaeria", "g_Elaphomyces", "g_Cortinarius", "g_Cenococcum", "g_Amanita", "g_Boletus")))) +
  geom_bar(stat = "identity", position = position_fill()) + coord_flip() +
    scale_fill_manual(values = c ("#e5f5f9", "#99d8c9", "#2ca25f", "#fee8c8", "#fdbb84", "#e34a33", "#e7e1ef", "#c994c7", "#dd1c77","#e5f5f9", "#99d8c9", "#2ca25f", "#fee8c8", "#fdbb84", "#e34a33", "#e7e1ef", "#c994c7", "#dd1c77", "#e5f5f9", "#99d8c9", "#2ca25f", "#fee8c8", "#fdbb84", "#e34a33", "#e7e1ef", "#c994c7", "#dd1c77")) + 
    guides(fill = guide_legend(reverse = TRUE, ncol = 1, keyheight = 0.8)) +
    facet_grid(~ Seq, drop = TRUE) +
   theme(text = element_text(size = 15)) + theme_gray()
```
